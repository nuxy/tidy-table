# Tidy Table [![Bower version](https://badge.fury.io/bo/tidy-table.svg)](https://badge.fury.io/bo/tidy-table) [![Build status](https://travis-ci.org/nuxy/Tidy-Table.svg?branch=master)](https://travis-ci.org/nuxy/Tidy-Table)
