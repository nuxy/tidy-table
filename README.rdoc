...
- Fast and lightweight (jQuery plug-in *only 3.5 kB)

== Installation

Please refer to the {README.html}[https://github.com/nuxy/Tidy-Table/blob/master/README.html] file for more information about this package.
